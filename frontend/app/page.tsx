  ...
  const features = [
    {
      ...
      description:
        "AI automatically discovers how temperature affects fish distribution, finds hidden patterns, and predicts where fish will be tomorrow.",
    ...
    },
    {
      ...
      description:
        "Upload any fish photo → Know the species instantly. Upload otolith image → Know fish age. Works offline on boats too!",
    ...
    },
    {
      ...
      description:
        "AI predicts best fishing spots, avoids overfished areas, shows fish movement patterns, and suggests optimal fishing times.",
    ...
    },
    {
      ...
      description:
        "Track ocean warming effects, identify species at risk, predict coral bleaching, and monitor sea level changes in real-time.",
    ...
    },
    {
      ...
      description:
        "Generate government reports, biodiversity assessments, fishing license applications, and environmental clearance documents instantly.",
    ...
    },
    {
      ...
      description:
        "AI warns about harmful algae blooms, predicts fish deaths, spots pollution early, and detects invasive species automatically.",
    ...
    },
    {
      ...
      description:
        "Explore ocean in 3D, virtually swim through data, watch fish migrations, and explore ocean floor in immersive detail.",
    ...
    },
    {
      ...
      description:
        "Talk to data like chatting, get instant answers, share findings with team, and use voice commands for hands-free operation.",
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 text-center">
              <h2 className="text-2xl font-semibold mb-6">
                🗺️ Real-Time Marine Intelligence Map
              </h2>
              <div className="relative h-80 bg-gradient-to-br from-blue-800 via-blue-700 to-blue-800 rounded-xl overflow-hidden">
                ...
                <div
                  className="absolute top-6 left-12 w-3 h-3 bg-cyan-400 rounded-full animate-bounce"
                  style={{ animationDelay: "0s" }}
                ></div>
                <div
                  className="absolute top-24 right-20 w-3 h-3 bg-green-400 rounded-full animate-bounce"
                  style={{ animationDelay: "1s" }}
                ></div>
                <div
                  className="absolute bottom-16 left-8 w-3 h-3 bg-yellow-400 rounded-full animate-bounce"
                  style={{ animationDelay: "2s" }}
                ></div>
                <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
                  <div className="text-6xl mb-4">🌍</div>
                  <div className="text-xl font-semibold mb-2">
                    Indian Ocean EEZ Live View
                  </div>
                  <div className="text-sm text-white/80">
                    Click anywhere to explore marine data • Zoom into fishing
                    zones • Track species migration
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-center">
              <p className="text-white/70 text-center text-sm sm:text-base">
                © {new Date().getFullYear()} CMLRE Marine Intelligence Platform.
                All Rights Reserved.
              </p>
            </div>
          </div>
