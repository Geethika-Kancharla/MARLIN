      ...
      <div className="relative w-full h-screen bg-gradient-to-b from-blue-200 via-cyan-200 to-blue-700 flex flex-col items-center justify-center overflow-hidden">
        ...
        <section className="z-10 w-full max-w-6xl mx-auto px-4 py-6 flex flex-col items-center text-center space-y-6">
          ...
          <p className="text-base md:text-lg lg:text-xl text-blue-900/90 bg-white/80 rounded-lg px-4 py-4 shadow-md leading-relaxed max-w-4xl">
            <span className="font-semibold">CMLRE, Kochi</span>, under the Ministry of Earth Sciences, 
            leads India’s marine data research. Our project is building an{" "}
            <span className="font-semibold">AI-enabled marine data platform</span> 
            to integrate, visualize, and analyze diverse datasets — from oceanography 
            and fisheries to taxonomy, otolith morphology, and molecular biology. 
            This platform transforms raw data into actionable insights for 
            sustainable ocean management and India’s blue economy growth.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 w-full max-w-5xl">
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 text-left border-l-8 border-blue-500">
              ...
              <ul className="list-disc pl-5 space-y-1 text-blue-700 text-sm md:text-base">
                <li>India’s vast coastline faces threats from climate change, overfishing, and pollution.</li>
                <li>Marine datasets are fragmented across silos, limiting real-time insights.</li>
                <li>Sustainable fisheries and conservation require integrated, science-driven tools.</li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg p-4 text-left border-l-8 border-cyan-500">
              <h2 className="text-lg md:text-xl font-semibold text-blue-800 mb-2 flex items-center gap-2">
                <FaDatabase className="text-cyan-600" /> What does this project do?
              </h2>
              <ul className="list-disc pl-5 space-y-1 text-blue-700 text-sm md:text-base">
                <li>🌊 Integrates datasets: oceanography, fisheries, taxonomy, eDNA, otoliths.</li>
                <li>📊 Visualizes real-time ocean health with dashboards, maps, and charts.</li>
                <li>🔬 AI-powered tools: fish recognition, eDNA analysis, predictive modeling.</li>
                <li>🤖 Supports policy & communities with reports, decision tools, and mobile apps.</li>
              </ul>
            </div>
          </div>
