...
import { Search, MapPin, Fish, Camera, BarChart3, AlertTriangle, FileText, Smartphone, Brain, Zap, Globe, MessageCircle, Crystal } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-900 via-blue-800 to-blue-900 text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <nav className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-xl font-bold">CMLRE Marine Intelligence</span>
            </div>
            
            <div className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-white/80 hover:text-white hover:bg-white/10 px-4 py-2 rounded-lg transition-all duration-300">Dashboard</a>
              <a href="#" className="text-white/80 hover:text-white hover:bg-white/10 px-4 py-2 rounded-lg transition-all duration-300">Data Explorer</a>
              <a href="#" className="text-white/80 hover:text-white hover:bg-white/10 px-4 py-2 rounded-lg transition-all duration-300">Fish Finder</a>
              <a href="#" className="text-white/80 hover:text-white hover:bg-white/10 px-4 py-2 rounded-lg transition-all duration-300">Research</a>
              <a href="#" className="text-white/80 hover:text-white hover:bg-white/10 px-4 py-2 rounded-lg transition-all duration-300">Reports</a>
              <button className="bg-white/20 border border-white/30 rounded-xl px-4 py-2 hover:bg-white/30 transition-all duration-300">
                Dr. Marine Biologist ▼
              </button>
            </div>
          </nav>
      ...
      <section className="py-16 text-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
            ...
            into one intelligent platform for India's marine future
          </p>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-4xl font-bold text-center mb-12">🎯 Main Features That Win Hackathons</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => {
              ...
              return (
                <div
                  key={index}
                  className="group bg-white/10 backdrop-blur-md rounded-3xl p-8 border border-white/20 hover:bg-white/15 hover:-translate-y-2 hover:shadow-2xl hover:shadow-cyan-500/20 transition-all duration-500 cursor-pointer hover:border-cyan-400/50"
                >
                  ...
                  <p className="text-cyan-400 text-sm font-medium mb-4">{feature.subtitle}</p>
                  <p className="text-white/80 mb-4 leading-relaxed">{feature.description}</p>
                  <p className="text-green-400 text-sm font-medium">{feature.benefit}</p>
                </div>
              );
            })}
          </div>
